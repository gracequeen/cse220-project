...
Graph* create_example_graph1()
{
    char vexs[] = {'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'};
    int matrix[][12] = {
             /*A*//*B*//*C*//*D*//*E*//*F*//*G*//*H*//*I*//*j*/
      /*A*/ {   0,  12, INF, INF, INF,  16,  14,  7,  INF,  20},
      /*B*/ {  12,   0,  10, INF, INF,   7, INF, INF,  25,  5 },
      /*C*/ { INF,  10,   0,   3,   5,   6, INF, 17,  INF,  9 },
      /*D*/ { INF, INF,   3,   0,   4, INF, INF, 30,    4,  INF},
      /*E*/ { INF, INF,   5,   4,   0,   2,   8, 15,  INF,  INF},
      /*F*/ {  16,   7,   6, INF,   2,   0,   9, 28,    6,  INF},
      /*G*/ {  14, INF, INF, INF,   8,   9,   0, 11,  INF, 10 },
      /*H*/ {  7,  INF,  17,  30,  15,  28,  11,  0,  INF,  8 },
      /*I*/ { INF,  25, INF,   4, INF,   6, INF, INF,   0, 15 },
      /*J*/ {  20,   5,   9, INF, INF, INF,  10,  8,   15,  0}};
    int vlen = LENGTH(vexs);
    int i, j;
    Graph* pG;
...
void main()
{
 ...
 //   int path1[MAX][MAX] = {0};    // 用于保存floyd路径
  //  int floy1[MAX][MAX] = {0};    // 用于保存floyd长度
    Graph* pG;
   // Graph* pG1;
